  ...
  return (
    <div className={styles.betaContainer}>
      ...
      <div className={styles.textContainer}>
        ...
        <p className={styles.androidExplain}>
          Manage repositories, checkout & merge branches, view & commit changes
          and much more, right from your Android device.
        </p>
        <a href="https://play.google.com/store/apps/details?id=dev.oceanbit.gitshark&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1">
          <img
