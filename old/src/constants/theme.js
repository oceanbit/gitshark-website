...
export const theme = {
  colors: {
    ...
    divider_no_alpha: new DynamicValue(
      colors.divider_no_alpha_light,
      colors.divider_no_alpha_dark
    ),
    ...
    svg_shadow: new DynamicValue(
      colors.svg_shadow_light,
      colors.svg_shadow_dark
    ),
  },
}
